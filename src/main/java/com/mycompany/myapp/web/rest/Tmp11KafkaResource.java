...
@RestController
@RequestMapping("/api/tmp-11-kafka")
public class Tmp11KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Tmp11KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Tmp11KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
