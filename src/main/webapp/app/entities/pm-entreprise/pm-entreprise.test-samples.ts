...
export const sampleWithRequiredData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-04-07'),
  dateEtat: dayjs('2025-04-06'),
  dateFermetureJuridique: dayjs('2025-04-07'),
  codeTrancheEffectif: 'gadzooks although muscat',
  libelleTrancheEffectif: 'trash plain',
  dateCessationActivite: dayjs('2025-04-07'),
  dateEffectifOfficiel: dayjs('2025-04-06'),
...
export const sampleWithPartialData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-04-07'),
  dateEtat: dayjs('2025-04-07'),
  dateFermetureJuridique: dayjs('2025-04-06'),
  codeTrancheEffectif: 'whoever eek',
  libelleTrancheEffectif: 'an',
  dateCessationActivite: dayjs('2025-04-06'),
  dateEffectifOfficiel: dayjs('2025-04-07'),
